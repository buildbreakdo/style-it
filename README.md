# <img alt="Reactive Style" height="60" src="https://s3.amazonaws.com/reactive-style/reactive-style-logo.svg?11263" />
...
Alternatively, if you are not using npm as your package manager the files can be downloaded directly from the [npm content delivery network](https://unpkg.com/reactive-style/).
...
####JSX syntax [<img title="OPEN IN JSFIDDLE" align="right" src="https://img.shields.io/badge/OPEN%20IN%20JSFIDDLE--eaeff2.svg" />](https://jsfiddle.net/y2pnqh9e/10/)
...
#### JavaScript variables in your CSS [<img title="OPEN IN JSFIDDLE" align="right" src="https://img.shields.io/badge/OPEN%20IN%20JSFIDDLE--eaeff2.svg" />](https://jsfiddle.net/y2pnqh9e/11/)
In:
```js
import React from 'react';
import Style from 'reactive-style';
...
| Small size                                |                   |              | Reactive Style is tiny at only 1.84kB gzipped. |
